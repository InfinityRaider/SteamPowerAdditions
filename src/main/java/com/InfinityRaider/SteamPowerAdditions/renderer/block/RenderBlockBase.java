package com.InfinityRaider.SteamPowerAdditions.renderer.block;

import com.InfinityRaider.SteamPowerAdditions.SteamPowerAdditions;
import com.InfinityRaider.SteamPowerAdditions.reference.Constants;
import com.InfinityRaider.SteamPowerAdditions.renderer.TessellatorV2;
import com.InfinityRaider.SteamPowerAdditions.tileentity.TileEntityBase;
import com.InfinityRaider.SteamPowerAdditions.utility.RenderHelper;
...
public abstract class RenderBlockBase  extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler, IItemRenderer {
    ...
    public final int getRenderId() {
        return SteamPowerAdditions.proxy.getRenderId(this.getBlock());
    }
    ...
    //UTILITY METHODS
    //---------------
    protected void rotateMatrix(TileEntityBase tileEntityAgricraft, Tessellator tessellator, boolean inverse) {
        //+x = EAST
        //+z = SOUTH
        //-x = WEST
        //-z = NORTH
